...
class CommunicationSystem:
    ...
    available_routes = [CommunicationType.TTC, CommunicationType.SSTV, CommunicationType.M17, CommunicationType.CODEC2]
    ...
    def begin(self, packet: DataPacket, now: float, signal: float) -> Transmission:
        ...
        self.active = Transmission(packet, mode, now, estimated_time=mode.estimate_transmission_time(packet, signal))
        return self.active
